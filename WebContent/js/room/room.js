...
function afterRequestARoom(data)
{
	...
	if (data.rVo.room.state == 2)
	{
		...
		$("#enteredFormId span[class=enteredWayDescriptionClass]").html(data.eVo.hourRoomDescription 
				+" ( "+data.rVo.room.roomType.dayPrice+" /天， "+data.rVo.room.roomType.hourPrice+" /小时 )");
